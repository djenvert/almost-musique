...
<tr>
	...
	<th><?php echo $paginator->sort('short_desc');?></th>
	<th><?php echo $paginator->sort('long_desc');?></th>
	<th><?php echo $paginator->sort('activity');?></th>
	<th><?php echo $paginator->sort('password');?></th>
	<th><?php echo $paginator->sort('group_id');?></th>
	<th><?php echo $paginator->sort('signature');?></th>
	<th><?php echo $paginator->sort('created');?></th>
	<th><?php echo $paginator->sort('modified');?></th>
	<th><?php echo $paginator->sort('last_login');?></th>
	<th><?php echo $paginator->sort('mobile_phone');?></th>
...
?>
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $user['User']['short_desc']; ?>
		</td>
		<td>
			<?php echo $user['User']['long_desc']; ?>
		</td>
		<td>
			<?php echo $user['User']['activity']; ?>
		</td>
		<td>
